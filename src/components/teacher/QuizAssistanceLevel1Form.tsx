...
import {
  upsertQuizAssistanceLevel1,
  deleteQuizAssistanceLevel1,
...
export default function QuizAssistanceLevel1Form({
  ...
  const [formData, setFormData] = useState<Partial<QuizAssistanceLevel1Input>>({
    ...
    description:
      ...
      "Pertanyaan Ya/Tidak untuk membantu siswa memahami materi",
    quizId: quizId,
  });

  const [questions, setQuestions] = useState<
    Partial<AssistanceQuestionYesNoInput>[]
  >([]);
              ...
              <div
                  ...
                  <div className="flex space-x-4">
                    ...
                    <label className="inline-flex items-center">
                      <input
                        ...
                        onChange={() =>
                          handleQuestionAnswerChange(index, false)
                        }
                      />
                      <span className="ml-2 text-gray-700 dark:text-gray-300">
                        Tidak
                ...
                <div className="mt-4">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                    placeholder="Berikan penjelasan singkat yang akan ditampilkan saat siswa menjawab salah"
                  />
                </div>
              </div>
            ))}
